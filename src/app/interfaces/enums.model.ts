...
export const SubTypeServiceOrderLabels: Record<SubTypeServiceOrder, string> = {
  ...
  [SubTypeServiceOrder.PROBLEMA_NAO_IDENTIFICADO_NOC]:
    "Problema não Identificado pelo NOC",
...
export const TypeToSubTypeMap: Record<TypeOfOs, SubTypeServiceOrder[]> = {
  ...
  [TypeOfOs.CHANGE_OF_ADDRESS]: [SubTypeServiceOrder.MUDANCA_DE_ENDERECO],
  [TypeOfOs.CHANGE_OF_TECHNOLOGY]: [SubTypeServiceOrder.MIGRACAO_TECNOLOGIA],
  [TypeOfOs.PROJECTS]: [
  ...
  [TypeOfOs.TECHNICAL_VIABILITY]: [SubTypeServiceOrder.VIABILIDADE_TECNICA],
  ...
  [TypeOfOs.INTERNAL]: [SubTypeServiceOrder.SERVICOS_INTERNOS_OAI],
};
...
export const ServiceOrderStatusSeverity: Record<
  ServiceOrderStatus,
...
export const TicketTopicsDescriptions: Record<TicketTopics, string> = {
  [TicketTopics.IT_SUPPORT]:
    "Problemas com computadores, impressoras, rede, monitores.",
  [TicketTopics.ELECTRICAL]: "Troca de lâmpadas, disjuntores, tomadas, fiação.",
  [TicketTopics.FURNITURE]:
    "Solicitações de montagem, reparo ou substituição de móveis.",
  [TicketTopics.PLUMBING]:
    "Problemas com encanamentos, vazamentos e instalações hidráulicas.",
  [TicketTopics.DOORS_AND_GATES]:
    "Manutenção e reparo de portas, portões e fechaduras.",
  [TicketTopics.GENERAL_MAINTENANCE]:
    "Manutenção geral, pintura, pequenos reparos.",
  [TicketTopics.CLEANING]:
    "Solicitações de limpeza e conservação de ambientes.",
  [TicketTopics.SECURITY]: "Câmeras, alarmes, sistemas de segurança.",
  [TicketTopics.HVAC]:
    "Instalação e manutenção de sistemas de aquecimento, ventilação e ar-condicionado.",
  [TicketTopics.MOVING_AND_SETUP]:
    "Serviços de mudança e montagem de equipamentos ou móveis.",
};
