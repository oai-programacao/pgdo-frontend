...
export const routes: Routes = [
  {
    ...
    children: [ // Rotas filhas que serão renderizadas DENTRO do router-outlet do MainLayoutComponent
      ...
      },
      {
        path: 'tecnicos',
        loadComponent: () =>
          import('./features/technicians/pages/technician-list/technician-list.component').then((m) => m.TechnicianListComponent),
        title: 'Técnicos',
      },
      {
        path: 'anotacoes',
        loadComponent: () =>
          import('./features/annotations/pages/manage-annotations/manage-annotations.component').then((m) => m.ManageAnnotationsComponent),
        title: 'Anotações',
      },
      {
        path: 'ordens-de-servico',
        loadComponent: () =>
          import('./features/service-orders/pages/list-service-order/list-service-order.component').then((m) => m.ListServiceOrderComponent),
        title: 'Ordens de Serviço',
      },
      {
        path: 'ordens-de-servico/nova',
        loadComponent: () =>
          import('./features/service-orders/pages/create-service-order/create-service-order.component').then((m) => m.CreateServiceOrderComponent),
        title: 'Nova Ordem de Serviço',
      },
      {
        path: 'ordens-de-servico/gerenciar',
        loadComponent: () =>
          import('./features/service-orders/pages/admin-service-orders/admin-service-orders.component').then((m) => m.AdminServiceOrdersComponent),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/offers/pages/block-offers-request/block-offers-request.component').then((m) => m.BlockOffersRequestComponent),
        title: 'Bloqueio de Ofertas',
      },
      {
        path: 'ordens-de-servico/automacao',
        loadComponent: () =>
          import('./features/offers-automations/pages/manage-offers-automations/manage-offers-automations.component').then((m) => m.ManageOffersAutomationsComponent),
        title: 'Gerenciar Automação de Ofertas',
      },
      {
        path: 'ordens-de-servico/endereco-cabeado',
        loadComponent: () =>
          import('./features/wired-address/pages/list-wired-address/list-wired-address.component').then((m) => m.ListWiredAddressComponent),
        title: 'Endereços Cabeados',
      },
      {
        path: 'minhas-vendas',
        loadComponent: () =>
          import('./features/sales/pages/seller-manage-sales/seller-manage-sales.component').then((m) => m.SellerManageSalesComponent),
        title: 'Minhas Vendas',
      },
      {
        path: 'vendas',
        loadComponent: () =>
          import('./features/sales/pages/admin-manage-sales/admin-manage-sales.component').then((m) => m.AdminManageSalesComponent),
        title: 'Gerenciar Vendas',
      },
      {
        path: 'pos-vendas',
        loadComponent: () =>
          import('./features/after-sales/pages/manage-after-sales/manage-after-sales.component').then((m) => m.ManageAfterSalesComponent),
        title: 'Pós Vendas',
      },
      {
        path: 'onus',
        loadComponent: () =>
          import('./features/onu/pages/manage-onu/manage-onu.component').then((m) => m.ManageOnuComponent),
        title: 'Gerenciar ONUs',
      },
      {
        path: 'olt/slot',
        loadComponent: () =>
          import('./features/olt/pages/olt-query-by-slot/olt-query-by-slot.component').then((m) => m.OltQueryBySlotComponent),
        title: 'Consulta por Slot',
      },
      {
        path: 'olt/usuarios',
        loadComponent: () =>
          import('./features/olt/pages/olt-users/olt-users.component').then((m) => m.OltUsersComponent),
        title: 'Usuários de OLT',
      },
      {
        path: 'chamados/criar-chamado',
        loadComponent: () =>
          import('./features/tickets/pages/create-ticket/create-ticket.component').then((m) => m.CreateTicketComponent),
        title: 'Criar Chamado',
      },
      {
        path: 'chamados/gerenciar',
        loadComponent: () =>
          import('./features/tickets/pages/manage-tickets/manage-tickets.component').then((m) => m.ManageTicketsComponent),
        title: 'Gerenciar Chamados',  
      },
      {
        path: 'troca-titularidade',
        loadComponent: () =>
          import('./features/change-owner/pages/change-owner/change-owner.component').then((m) => m.ChangeOwnerComponent),
